...
from gym_cooking.environment.game import failure_message_display
...
class Game:
    ...
    def __init__(self, env, num_humans, hlas, max_steps=100, render=False, idx_human=0, carpet = False):
        self._running = True
        self.env = env
        ...
        self.graphics_pipeline = failure_message_display.GraphicPipeline(env, hlas= hlas, display=self.render)
