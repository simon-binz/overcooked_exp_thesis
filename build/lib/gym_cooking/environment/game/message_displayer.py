...
class GraphicPipeline:
    ...
    def __init__(self, env, message = None, display=False):
        self.env = env
        ...
        self.general_text = self.font.render(message, True, Color.BLACK, Color.WHITE)
        self.general_text_rect= self.general_text.get_rect()
        self.general_text_rect.center = (self.excess_width + self.graphics_properties.width_pixel*0.5+self.PIXEL_PER_TILE,
    ...
    def on_render(self):
        ...
        text_rect.center = (self.excess_width + self.graphics_properties.width_pixel*0.5+self.PIXEL_PER_TILE,
                            self.excess_height + self.graphics_properties.height_pixel/2)
